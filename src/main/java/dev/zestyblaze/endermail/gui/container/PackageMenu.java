package dev.zestyblaze.endermail.gui.container;
        ...
        for (int j = 0; j < packageContainer.getContainerSize(); ++j) {
            addSlot(new Slot(packageContainer, j, 44 + j * 18, 20) {
                ...
                public boolean mayPlace(ItemStack stack) {
                    return !ConfigHandler.GENERAL.packageContentsBlacklist.get().contains(BuiltInRegistries.ITEM.getKey(stack.getItem()).toString());
                }
            });
        }
